package kr.co.bbibi.finestwebview;
...
import kr.co.bbibi.finestwebview.helpers.BitmapHelper;
import kr.co.bbibi.finestwebview.helpers.ColorHelper;
import kr.co.bbibi.finestwebview.helpers.TypefaceHelper;
import kr.co.bbibi.finestwebview.helpers.UrlParser;
import kr.co.bbibi.finestwebview.listeners.BroadCastManager;
import kr.co.bbibi.finestwebview.views.ShadowLayout;
...
import kr.co.bbibi.finestwebview.util.BackPressCloseSystem;
...
public class FinestWebViewActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    protected void initializeOptions() {
        ...
        webViewSupportMultipleWindows = builder.webViewSupportMultipleWindows != null ? builder.webViewSupportMultipleWindows : true;
        ...
        webViewJavaScriptCanOpenWindowsAutomatically = builder.webViewJavaScriptCanOpenWindowsAutomatically != null ? builder.webViewJavaScriptCanOpenWindowsAutomatically : true;
    ...
    protected void initializeViews() {
        ...
        { // WebView
            ...
            //하기 업로드, window.open 부분이 소스추가수정되었음 by neo@bbibi.co.kr --- start
            //아래의 다음메서드와 세트임 protected void onActivityResult(int requestCode, int resultCode, Intent data) {
            //출처 - http://trend21c.tistory.com/1912 --> https://github.com/spotlight21c/AndroidOpenFileChooser

            webView.setWebChromeClient(new MyWebChromeClient() {
                // For Android < 3.0
                public void openFileChooser( ValueCallback<Uri> uploadMsg) {
                    Log.d("Android Version: ", "3.0 <");
            ...
            //상기파일 업로드, window.open 부분이 소스추가수정되었음 by neo@bbibi.co.kr --- end
...
//        }
    ...
    private BackPressCloseSystem backPressCloseSystem; // by neo@bbibi.co.kr

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        backPressCloseSystem = new BackPressCloseSystem(this); // by neo@bbibi.co.kr
        // 뒤로 가기 버튼 이벤트
        initializeOptions();
    ...
    public void onBackPressed() {
        ...
        if (menuLayout.getVisibility() == View.VISIBLE) {
            ...
            backPressCloseSystem.onBackPressed(); // by neo@bbibi.co.kr
    ...
    public class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.endsWith(".mp4")) {
                ...
                return true;
            } else if (url.startsWith("tel:") || url.startsWith("sms:") || url.startsWith("smsto:") || url.startsWith("mms:") || url.startsWith("mmsto:") || url.startsWith("storylink:") || url.startsWith("mailto:") || url.startsWith("kakaolink:" )) {
