...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FinestWebView.Builder(this)
                ...
                .show("http://bbibi.co.kr/index.php?mobile=pc");
    }
...
//                    .show("http://www.youtube.com");
                    .show("http://bbibi.co.kr/html_file.php?file=market_index.html&file2=default_market.html");
...
//            startActivity(intent);
            ...
            new FinestWebView.Builder(this)
                    ...
                    .show("http://bbibi.co.kr/100_search_bbibi.php?action=&pg=1&sort_product=&sort_how=new");
...
//                    .setCustomAnimations(R.anim.fade_in_fast, R.anim.fade_out_medium, R.anim.fade_in_medium, R.anim.fade_out_fast)
                    ...
                    .show("http://bbibi.co.kr/happy_member_login.php?returnUrl=100_car_add.php");
        }
    }
